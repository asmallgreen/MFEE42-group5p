...
$sql="INSERT INTO membership (account, password, name, gender, birthday, email, phone, address, created_at, valid) VALUES ( '$account','$md5Password','$name', '$gender', '$birthday', '$email', '$phone', '$fullAddress','$now', 1)";
