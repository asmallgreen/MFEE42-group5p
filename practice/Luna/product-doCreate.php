...
$sql = "INSERT INTO product_bow (name, category,item , price, img_s1, img_s2, img_s3, img_s4, img_s5, img_m, created_at, valid, description) VALUES ('$name', '$category','$item',  '$price', '$img_s1', '$img_s2', '$img_s3', '$img_s4', '$img_s5', '$img_m', '$now', 1, '$description')";
